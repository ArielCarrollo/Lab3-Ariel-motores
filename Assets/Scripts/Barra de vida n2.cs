...
public class Barra_de_vida_n2 : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        gAMEmANAGER2.PlayerDamaged += UpdatePlayerUI;
    }
    void OnDisable()
    {
        gAMEmANAGER2.PlayerDamaged -= UpdatePlayerUI;
    ...
    void UpdatePlayerUI()
    {
        if (Vidaplayer.GetComponent<CONTROLES>().Vidas == 10)
        {
            _spriteRenderer.sprite = _sprite[9];
        }
